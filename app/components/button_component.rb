class ButtonComponent < ViewComponent::Base
  ...
  def initialize(tag: '', type: '', id: '', href: '', text: '', tailwind_class: '', data: {}, leading_visual: {}, trailing_visual: {})
    @tag = tag
    @type = type
    @id = id
    @href = href
    ...
    @data = build_html_element_data_attributes || nil
    @leading_visual = build_html_element_leading_visual || nil
    @trailing_visual = build_html_element_trailing_visual || nil
  end
