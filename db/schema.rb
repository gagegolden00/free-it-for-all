...
ActiveRecord::Schema[7.0].define(version: 20_231_021_205_934) do
  ...
  create_table 'service_report_materials', force: :cascade do |t|
    ...
    t.index %w[service_report_id material_id], name: 'unique_index_on_service_report_and_material', unique: true
  ...
  create_table 'user_service_jobs', force: :cascade do |t|
    ...
    t.index %w[user_id service_job_id], name: 'index_user_service_jobs_on_user_id_and_service_job_id', unique: true
